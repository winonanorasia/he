                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="active has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
								<li>
									<a href="tbl_data_kriteria.html">
										<i class="fas fa-chart-bar"></i>DATA KRITERIA</a>
								</li>
								<li>
									<a href="tbl_data_alternatif.html">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                         <?php
                                            foreach ($data as $key) {
                                            ?>
                                             <form action="<?php echo base_url('index.php/admin/edit_kriteria_action/').$key->id_kriteria?>" method="post" enctype="multipart/form-data" class="form-horizontal">
											 ...
											 <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="text-input" name="kriteria" value="<?php echo $key->nama_kriteria;?>" class="form-control">
                                                    </div>
                                            </div>
											<div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <select name="atribut" id="select" class="form-control">
                                                        <option value="<?php echo $key->tipe_kriteria;?>"><?php echo $key->tipe_kriteria;?></option>
                                            ...
                                            <div class="row form-group">
                                               ...
                                               <div class="col-12 col-md-9">
                                                   <input type="text" id="text-input" name="bobot" value="<?php echo $key->bobot_kriteria;?>" class="form-control">
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <button type="cancel" class="btn btn-danger btn-sm" >
                                            <a href="<?php echo base_url('index.php/admin/data_kriteria')?>"><i class="fa fa-ban"></i> Batal</a>
                                        </button>
                                    </div>
                                    <?php
                                }
