                    ...
                    <ul class="list-unstyled navbar__list">
						...
						<li class="active has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
								...
								<li>
									<a href="<?php echo base_url('index.php/admin/alternatif')?>">
										<i class="fas fa-table"></i>DATA ALTERNATIF</a>
								</li>
								<li>
									<a href="<?php echo base_url('index.php/admin/hasil_seleksi')?>">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">DATA ALTERNATIF</h3>
                                
                                    <div class="table-data__tool-right">
                                        <a href="<?php echo base_url('index.php/admin/tambah_alternatif')?>" class="au-btn au-btn-icon au-btn--green au-btn--small">
                                               ...
                                               <?php
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        <a href="<?php echo base_url('index.php/admin/edit_alternatif/').$key->id_alternatif;?>" class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                            <i class="zmdi zmdi-edit"></i>
                                                        </a>
                                                        <a href="<?php echo base_url('index.php/admin/hapus_alternatif/').$key->id_alternatif;?>" class="item" data-toggle="tooltip" data-placement="top" title="Delete">
